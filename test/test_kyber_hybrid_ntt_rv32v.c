...
extern void ntt_hybridx2_rv32imv(int16_t *a, const uint32_t *scalar_zetas,
                                 const int16_t *vector_zetas);
extern void ntt_hybridx3_rv32imv(int16_t *a, const uint32_t *scalar_zetas,
                                 const int16_t *vector_zetas);

int main()
{
    int16_t a[KYBER_N * 3], b[KYBER_N], c0[KYBER_N], c1[KYBER_N], i, j;
    ...
    PERF(ntt_rvv(b, qdata), ntt_rvv);
    PERF(ntt_hybridx2_rv32imv(a, zetas_ntt_rv32im, qdata),
         ntt_hybridx2_rv32imv);
    PERF(ntt_hybridx3_rv32imv(a, zetas_ntt_rv32im, qdata),
         ntt_hybridx3_rv32imv);
    PERF(ntt_hybridx4_rv32imv(a, zetas_ntt_rv32im, qdata),
