...
int32_t treeINTTMerged_7layer[] = {
    ...
    5,  69, 37,  101, 21, 85, 53,  117, 13, 77, 45,  109, 29,  93, 61,  125,
    2,  66, 34,  98,  18, 82, 50,  114, 10, 74, 42,  106, 26,  90, 58,  122,
    4,  68, 36,  100, 20, 84, 52,  116, 8,  72, 40,  104, 16,  80, 32,  3,
    67, 35, 99,  19,  83, 51, 115, 11,  75, 43, 107, 27,  91,  59, 123, 7,
    71, 39, 103, 23,  87, 55, 119, 15,  79, 47, 111, 31,  95,  63, 127, 6,
    70, 38, 102, 22,  86, 54, 118, 14,  78, 46, 110, 30,  94,  62, 126, 12,
    76, 44, 108, 28,  92, 60, 124, 24,  88, 56, 120, 48,  112, 96, 64};
...
void GenTables_7layer(void)
{
    int32_t t;
    int16_t t0;
    int32_t table_zeta[127], table_zetaqinv[127];
    size_t index;
